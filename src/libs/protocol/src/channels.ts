...
import type { CallMetadata } from "./callMetadata.js";
...
export interface BrowserContextEventTarget {
  ...
  on(
    event: "console",
    callback: (params: BrowserContextConsoleEvent) => void,
  ): this;
  on(
    event: "close",
  ...
  on(
    event: "dialog",
    callback: (params: BrowserContextDialogEvent) => void,
  ): this;
  on(event: "page", callback: (params: BrowserContextPageEvent) => void): this;
  on(
    event: "pageError",
    callback: (params: BrowserContextPageErrorEvent) => void,
  ): this;
  on(
    event: "route",
  ...
  on(
    event: "webSocketRoute",
    callback: (params: BrowserContextWebSocketRouteEvent) => void,
  ): this;
  on(
    event: "video",
...
export interface PageEventTarget {
  ...
  on(
    event: "webSocketRoute",
    callback: (params: PageWebSocketRouteEvent) => void,
  ): this;
...
export interface PageChannel extends PageEventTarget, EventTargetChannel {
  ...
  close(
    params: PageCloseParams,
    metadata?: CallMetadata,
  ): Promise<PageCloseResult>;
  emulateMedia(
  ...
  requestGC(
    params?: PageRequestGCParams,
    metadata?: CallMetadata,
  ): Promise<PageRequestGCResult>;
...
export interface FrameChannel extends FrameEventTarget, Channel {
  ...
  blur(
    params: FrameBlurParams,
    metadata?: CallMetadata,
  ): Promise<FrameBlurResult>;
  check(
  ...
  fill(
    params: FrameFillParams,
    metadata?: CallMetadata,
  ): Promise<FrameFillResult>;
  focus(
  ...
  type(
    params: FrameTypeParams,
    metadata?: CallMetadata,
  ): Promise<FrameTypeResult>;
  uncheck(
...
export interface WebSocketRouteEventTarget {
  ...
  on(
    event: "closePage",
    callback: (params: WebSocketRouteClosePageEvent) => void,
  ): this;
  on(
    event: "closeServer",
    callback: (params: WebSocketRouteCloseServerEvent) => void,
  ): this;
}
export interface WebSocketRouteChannel
  extends WebSocketRouteEventTarget,
    Channel {
...
export interface ElectronApplicationEventTarget {
  ...
  on(
    event: "console",
    callback: (params: ElectronApplicationConsoleEvent) => void,
  ): this;
}
