...
import type { SerializedError } from "../../../protocol/src/channels.js";
import { isError } from "../utils.js";
import {
  parseSerializedValue,
  serializeValue,
} from "../protocol-utils/serializers.js";
...
export function isTargetClosedError(error: Error) {
  return (
    error instanceof TargetClosedError || error.name === "TargetClosedError"
  );
}
