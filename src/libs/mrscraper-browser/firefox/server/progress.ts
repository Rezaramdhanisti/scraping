...
import { assert, monotonicTime } from "../utils.js";
import type { LogName } from "../utils.js";
import type { CallMetadata } from "@protocol/callMetadata.js";
...
export class ProgressController {
  ...
  async run<T>(
    ...
    const progress: Progress = {
      ...
      timeUntilDeadline: () =>
        this._deadline ? this._deadline - monotonicTime() : 2147483647, // 2^31-1 safe setTimeout in Node.
