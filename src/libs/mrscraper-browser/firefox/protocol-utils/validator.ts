...
import {
  ...
  tChannel,
  tType,
} from "./validatorPrimitives.js";
export type { Validator, ValidatorContext } from "./validatorPrimitives.js";
export {
  ValidationError,
  findValidator,
  maybeFindValidator,
...
scheme.SerializedValue = tObject({
  ...
  s: tOptional(tString),
  v: tOptional(
    tEnum(["null", "undefined", "NaN", "Infinity", "-Infinity", "-0"]),
  ),
  d: tOptional(tString),
  u: tOptional(tString),
...
scheme.BrowserTypeLaunchPersistentContextParams = tObject({
  ...
  colorScheme: tOptional(
    tEnum(["dark", "light", "no-preference", "no-override"]),
  ),
  reducedMotion: tOptional(tEnum(["reduce", "no-preference", "no-override"])),
  forcedColors: tOptional(tEnum(["active", "none", "no-override"])),
  acceptDownloads: tOptional(
    tEnum(["accept", "deny", "internal-browser-default"]),
  ),
  baseURL: tOptional(tString),
...
scheme.BrowserContextWaitForEventInfoResult = tType(
  "EventTargetWaitForEventInfoResult",
);
scheme.PageWaitForEventInfoResult = tType("EventTargetWaitForEventInfoResult");
scheme.WebSocketWaitForEventInfoResult = tType(
  "EventTargetWaitForEventInfoResult",
);
scheme.ElectronApplicationWaitForEventInfoResult = tType(
  "EventTargetWaitForEventInfoResult",
);
scheme.AndroidDeviceWaitForEventInfoResult = tType(
  "EventTargetWaitForEventInfoResult",
);
...
scheme.BrowserContextSetDefaultNavigationTimeoutNoReplyResult = tOptional(
  tObject({}),
);
...
scheme.BrowserContextSetNetworkInterceptionPatternsResult = tOptional(
  tObject({}),
);
...
scheme.BrowserContextSetWebSocketInterceptionPatternsResult = tOptional(
  tObject({}),
);
...
scheme.FrameClickParams = tObject({
  ...
  noWaitAfter: tOptional(tBoolean),
  modifiers: tOptional(
    tArray(tEnum(["Alt", "Control", "ControlOrMeta", "Meta", "Shift"])),
  ),
  position: tOptional(tType("Point")),
  delay: tOptional(tNumber),
  button: tOptional(tEnum(["left", "right", "middle"])),
...
scheme.ElementHandleEvaluateExpressionResult = tType(
...
scheme.ElementHandleGetPropertyListResult = tType(
