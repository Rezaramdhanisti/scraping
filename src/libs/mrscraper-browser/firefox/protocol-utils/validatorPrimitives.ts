...
import { isUnderTest } from "../utils.js";
...
export const tNumber: Validator = (
  arg: any,
  path: string,
  context: ValidatorContext,
) => {
...
export const tBoolean: Validator = (
  arg: any,
  path: string,
  context: ValidatorContext,
) => {
...
export const tString: Validator = (
  arg: any,
  path: string,
  context: ValidatorContext,
) => {
...
export const tBinary: Validator = (
  arg: any,
  path: string,
  context: ValidatorContext,
) => {
...
export const tUndefined: Validator = (
  arg: any,
  path: string,
  context: ValidatorContext,
) => {
