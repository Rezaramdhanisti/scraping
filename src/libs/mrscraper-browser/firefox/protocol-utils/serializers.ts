...
import type { SerializedValue } from "../../../protocol/src/channels.js";
...
function isURL(obj: any): obj is URL {
  return (
    obj instanceof URL || Object.prototype.toString.call(obj) === "[object URL]"
  );
}
...
function isError(obj: any): obj is Error {
  ...
  return (
    obj instanceof Error || proto?.name === "Error" || (proto && isError(proto))
  );
}
