...
} from "./data/browser-data.js";
import { Cache } from "./Cache.js";
import { detectBrowserPlatform } from "./detectPlatform.js";
import { debugGenerator } from "../utils.js";

const debugLaunch = debugGenerator("browsers:launcher");
...
export class Process {
  ...
  constructor(opts: LaunchOptions) {
    ...
    debugLaunch("Launching browser process");

    this.#browserProcess = childProcess.spawn(
      // "/usr/bin/flatpak",
      // ["run", "io.github.ungoogled_software.ungoogled_chromium", ...this.#args],
      this.#executablePath,
      this.#args,
      {
        detached: opts.detached,
    ...
    console.log(
      `\n=============\n Browser process launched ${this.#browserProcess.pid} \n=============\n`,
    );
    if (opts.dumpio) {
