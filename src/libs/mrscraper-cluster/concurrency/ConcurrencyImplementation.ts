import { Page, LaunchOptions, ConnectOptions } from "puppeteer";
import { Connection } from "../../mrscraper-browser/cdp/Connection.js";
import { ProxyServer } from "../util.js";
...
export default abstract class ConcurrencyImplementation {
  ...
  public constructor(
    ...
    puppeteer: any,
    restartFunction: () => Promise<string> = async () => "",
  ) {
  ...
  public abstract workerInstance(
    ...
    restartFunction: (() => Promise<any>) | undefined,
...
export interface WorkerInstance {
   ...
   * an error)
   */
  repair: (proxy?: ProxyConfig) => Promise<void>;
}
